...
static card_template_t display_minion_general(card_template_t,std::string,int,std::string,std::string,
                                              std::string,int);
...
static card_template_t display_minion_general(card_template_t out,std::string name,int cost, std::string attack, std::string defence,std::string desc,int ability_cost) {
  std::ostringstream oss;
  prepare_for_replace(out);
  replace_text_left(out,'N',name);
  oss << cost;
